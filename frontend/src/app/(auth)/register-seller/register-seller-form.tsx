...
export function RegisterSellerForm({
  ...
  const handleLogout = async () => {
    ...
    try {
      ...
      toast.success(
        'Đăng xuất thành công. Bây giờ bạn có thể đăng ký tài khoản Người bán!',
      );
        ...
        <Card className="flex flex-col w-full max-h-full shadow-lg max-w-2xl justify-center mx-auto p-6 sm:p-10 animate-fade-in relative overflow-hidden">
          ...
          <CardHeader className="text-center pb-6 sm:pb-8">
            ...
            <CardDescription className="text-base sm:text-lg mt-2">
              Tài khoản hiện tại của bạn là <b>{user.username}</b> (vai trò:
              Khách hàng). Đăng ký trở thành Người bán yêu cầu một tài khoản
              riêng biệt. Bạn cần đăng xuất tài khoản này trước khi tạo tài
              khoản Người bán mới.
            </CardDescription>
          </CardHeader>
