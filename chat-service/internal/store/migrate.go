...
// migrationsFS nhung toan bo file .sql trong thu muc migrations vao binary. Duong dan
// la tuong doi so voi FILE nay, nen migrations/ phai nam trong internal/store/.
//
//go:embed migrations/*.sql
var migrationsFS embed.FS

// RunMigrations chay migration embedded len DB#4 TRUOC khi service nhan request. Goi luc
// boot, fail-fast neu loi. migrate.ErrNoChange (khong co migration moi) KHONG phai loi.
...
// (host, query sslmode=require). pgxpool o part sau van dung URL goc, khong doi.
