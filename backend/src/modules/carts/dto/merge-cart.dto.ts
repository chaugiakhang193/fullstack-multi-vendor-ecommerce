...
import { IsUUID, IsNotEmpty, IsInt, Min, Max, IsOptional, IsArray, ValidateNested } from 'class-validator';
...
export class GuestCartItemDto {
  ...
  @ApiPropertyOptional({ description: 'ID biến thể (nếu có)', example: 'a0b9f418-2e8f-4cb1-8cb5-4cfeb9d701e7' })
  @IsUUID()
  @IsOptional()
  variant_id?: string;
...
export class MergeCartDto {
  @ApiProperty({ type: [GuestCartItemDto], description: 'Danh sách sản phẩm từ localStorage khách' })
  @IsArray()
