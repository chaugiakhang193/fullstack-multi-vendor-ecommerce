...
export class AddUserCouponUnique1781654313860 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_notification_user_read_created"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "user_coupon" ADD CONSTRAINT "UQ_5e9c3e76a1d975269ceb52f66af" UNIQUE ("user_id", "coupon_id")`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "user_coupon" DROP CONSTRAINT "UQ_5e9c3e76a1d975269ceb52f66af"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_notification_user_read_created" ON "notification" ("created_at", "is_read", "user_id") `,
    );
    await queryRunner.query(
      `ALTER TABLE "notification" ADD CONSTRAINT "FK_notification_user" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }
}
