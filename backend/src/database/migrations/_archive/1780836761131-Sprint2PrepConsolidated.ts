...
export class Sprint2PrepConsolidated1780836761131 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "coupon" ADD "used_count" integer NOT NULL DEFAULT '0'`,
    );
    await queryRunner.query(
      `ALTER TABLE "shop" ALTER COLUMN "is_coordinates_verified" SET DEFAULT false`,
    );
    await queryRunner.query(
      `ALTER TABLE "product" ADD CONSTRAINT "CHK_1149738dc84b1cadb48a928eaa" CHECK (stock_quantity >= 0)`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "product" DROP CONSTRAINT "CHK_1149738dc84b1cadb48a928eaa"`,
    );
    await queryRunner.query(
      `ALTER TABLE "shop" ALTER COLUMN "is_coordinates_verified" SET DEFAULT true`,
    );
