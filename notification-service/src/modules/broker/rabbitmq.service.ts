...
// Kết nối RabbitMQ ở tầng infra (Phase 2) — CHƯA consume gì.
// Connect non-fatal: nếu broker chưa sẵn sàng (CloudAMQP free tier cold, hoặc
// chưa khai env), app vẫn boot bình thường thay vì crash toàn bộ service vì
// một dependency ngoài chưa proven.
@Injectable()
